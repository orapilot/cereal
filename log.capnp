...
struct LiveCalibrationData {
  ...
  wideFromDeviceEuler @7 :List(Float32);

  warpMatrixDEPRECATED @8 :List(Float32);
  calStatusDEPRECATED @9 :Int8;
  warpMatrix2DEPRECATED @10 :List(Float32);
  warpMatrixBigDEPRECATED @11 :List(Float32);
